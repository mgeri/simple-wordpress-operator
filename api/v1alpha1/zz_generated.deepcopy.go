...
func (in *SimpleWordpressList) DeepCopyInto(out *SimpleWordpressList) {
	*out = *in
	...
	if in.Items != nil {
		...
		*out = make([]SimpleWordpress, len(*in))
		for i := range *in {
...
func (in *SimpleWordpressStatus) DeepCopy() *SimpleWordpressStatus {
	if in == nil {
		return nil
	}
	out := new(SimpleWordpressStatus)
	in.DeepCopyInto(out)
	return out
}
